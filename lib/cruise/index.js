		...
		return (
			<div onClick={()=>{this.state.hovering ? this.setState({hovering:false}) : this.setState({hovering:true});}} >
				<VelocityComponent {...animationProps}>
					<MgHeader headerTitle="邮轮" gotoBack={true} />
				</VelocityComponent>
				{
					this.state.LOADINGTIP ? (
						...
						<AMUI.Container className="container-scrollable" transition={transition} component="div" scrollable {...this.props}>
							...
							<nav className="mg-areanav g">
							    <div className="col mg-areanav-active">
							        <a href="javascript:;" title="">
							            <span><img src="/i/tanker/area1.jpg" width="100%" alt="" /></span>
							            <h3 className="mg-fs28">日韩</h3>
							        </a>
							    </div>
							    <div className="col">
							        <a href="javascript:;" title="">
							            <span><img src="/i/tanker/area2.jpg" width="100%" alt="" /></span>
							            <h3 className="mg-fs28">东南亚</h3>
							        </a>
							    </div>
							    <div className="col">
							        <a href="javascript:;" title="">
							            <span><img src="/i/tanker/area3.jpg" width="100%" alt="" /></span>
							            <h3 className="mg-fs28">地中海</h3>
							        </a>
							    </div>
							    <div className="col">
							        <a href="javascript:;" title="">
							            <span><img src="/i/tanker/area4.jpg" width="100%" alt="" /></span>
							    ...
							    <div className="mg-tjcp-warp">
							        <div className="mg-tjcp-bx">
							            <a className="mg-tjcp-img" href="">
							                ...
							                <img src="/i/tanker/product1.jpg" width="100%" alt="" />
							            </a>
							            <a className="mg-tjcp-img" href="">
							                <em className="mg-fs22">限时低价抢购</em>
							                <h4 className="mg-fs22 cf"><span className="fl">跟团游丨深圳出发</span><span className="fr">产品编号 2365889</span></h4>
							...
							<section className="mg-cplist mg-mt35">
							    <div className="mg-cplist-bx">
							        <a className="cf" href="">
							            <span className="mg-cplist-img fl"><img src="/i/tanker/product-list1.jpg" width="100%" alt="" /></span>
							            <div className="mg-cplist-r">
							                <h3 className="mg-fs26 mg-color-6a6a6a">日本长崎+九重+熊本+福冈5日日本长崎+九重+熊本+福冈5日[跟团游]</h3>
							                <p className="mg-color-999 mg-fs20">香港出发</p>
							                <p className="mg-color-999 mg-fs20 cf"><span className="fl">出发日期：2016-05-21</span> <span className="fr"><del>原价300</del> <span className="mg-color-yellow mg-ml10 mg-fs28"><span className="mg-fs20">¥</span><strong>190</strong>起</span></span></p>
							            </div>
							        </a>
							    </div>
							</section>
