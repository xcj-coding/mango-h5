...
import {NavBottom,LoadingTip} from '../common/component';
...
class CRUISE extends Component{
	...
	componentWillMount(){
		let {LOADINGTIP,ACTIONS} = this.props;
		this.setState({loading:true});
		// this.setState({bbb:true});
	}
	render(){
		let transition = 'sfr';
		return (
...
function mapStateToProps(state){
    return {
        LOADINGTIP:state.reducer.get('LOADINGTIP')
    };
};
...
export default connect(mapDispatchToProps)(CRUISE);

// function mapStateToProps(state){
//     return {
//         LOGINFAILURE:state.MdCount.get('LOGINFAILURE')
//     };
// };
// function mapDispatchToProps(dispatch){
//     return {
...
//     };
// };
// export default   connect(mapStateToProps,mapDispatchToProps)(CM.MonitorTitleEnhance(TenderDetail));