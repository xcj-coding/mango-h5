						...
						<div>
							...
							<section className="mg-productlist">
								<div className="mg-productlist-t">
									<h2 className="mg-tit1 cf">出境跟团游  <a className="mg-tit1-more fr" href="">更多<em className="mg-ico2-sjr"></em></a></h2>
							...
							<section className="mg-productlist">
								<div className="mg-productlist-t">
									<h2 className="mg-tit1 cf">国内跟团游  <a className="mg-tit1-more fr" href="">更多<em className="mg-ico2-sjr"></em></a></h2>
									<ul className="mg-productlist-list1 mg-g">
										<li className="mg-col mg-col-2">
											<a href=""><img src="/i/holiday/img2.jpg" width="100%" alt="" />
											<strong>北京</strong></a>
